...
<div class="clearfix">
  <div class="cls-acct-left pl-no">
    <ul>
      ...
      <li class='active'><a href="<?php echo wc_customer_edit_account_url(); ?>"><?php _e('Edit Profile', 'coffeeinaplace'); ?></a></li>
        ...
        <form class="edit-account" action="" method="post">
          ...
          <div class="btn-hlder sve-chnge">
            ...
            <?php wp_nonce_field( 'save_account_details' ); ?>
              <input type="submit" class="button trns-2" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>" />
